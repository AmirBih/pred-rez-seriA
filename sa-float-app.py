...
#ucitavanje modela
model = tf.keras.models.load_model("sa_float_model.h5")
...
sentimentalnost = "Pobjednik Domacin" if predvidjanje[0][0] >0.5 else "Pobjednik Gost" if predvidjanje[0][0] < -0.5 else "Pobjednik Neizvjestan"
